...
export function TodoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#121212]">
      <header className="bg-[#000000] px-6 flex justify-between items-center sticky top-0 z-10 h-[64px]">
        <svg viewBox="0 0 168 168" className="w-7 h-7 fill-[#1ed760]" xmlns="http://www.w3.org/2000/svg">
        ...
        <button
          ...
          className="h-8 px-5 rounded-full border border-[#878787] text-white text-xs font-bold uppercase tracking-[1.4px] hover:border-white hover:scale-105 transition-all"
        >
          로그아웃
        </button>
      </header>
